...
int main(int argc, char** argv) {
    ...
    ros::Subscriber sub = nh.subscribe("/livox/lidar", 300, cloud_callback);
    ROS_INFO("Point Cloud subscriber ready!");
    
    // Create the ROS Publisher and publish the accumulate cloud
    pub = nh.advertise<sensor_msgs::PointCloud2>("aligned_cloud", 300);
